...
class Rawdownload extends \Magento\Backend\App\Action
{
    
    protected $_publicActions = ['rawdownload'];
    ...
    public function execute()
    {
        ...
        $customDir = $this->directory_list->getPath('media').'/personalized/uploads/';
        $file_arr=array();
        ...
        if (count($file_arr)>0) {
            $result = $this->create_zip($file_arr, "milople_raw_personalized_products.zip");
        }
