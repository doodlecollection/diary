...
*
**/
namespace Milople\Personalizedcool\Block\Adminhtml\Category;
...
class Edit extends Container
{
    ...
    {
        if ($this->coreRegistry->registry('personalized_category_category')->getId()) {
            return __("Edit Gallery '%1'", $this->escapeHtml($this->coreRegistry->registry('personalized_category_category')->getName()));
        } else {
