...
class PackRepository implements PackRepositoryInterface
{
    ...
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        ...
        $packCollection->getSelect()->where(
            '(ISNULL(main_table.' . PackInterface::DATE_FROM . ') || main_table.' . PackInterface::DATE_FROM . ' <= NOW()) AND ' .
            '(ISNULL(main_table.' . PackInterface::DATE_TO . ') || main_table.' . PackInterface::DATE_TO . ' >= NOW())'
        );
