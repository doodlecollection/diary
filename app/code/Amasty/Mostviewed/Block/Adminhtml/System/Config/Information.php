...
class Information extends Fieldset
{
    ...
    public function getAdditionalModuleContent()
    {
        ...
        if ($this->moduleManager->isEnabled('Magento_GraphQl')
            ...
            $message = [
                'type' => 'message-notice',
                'text' => __('Enable customers-also-viewed-graphql module to activate GraphQl and Automatic Related Products integration. '
                    . 'Please, run the following command in the SSH: composer require amasty/customers-also-viewed-graphql')
            ];
